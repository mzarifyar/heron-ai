...
- `audit`: 6
- `caa_assistant`: 10
- `caa_clinical_calculator`: 2
- `caa_nursing`: 1
- `caa_oeo_patient_scheduling_agent`: 29
- `caad`: 23
- `canary`: 6
- `cda_app`: 5
- `cda_data_action_service`: 8
- `cda_oeo_common`: 3
- `cda_offline_summaries`: 1
- `cda_online_summaries`: 4
- `cdaf_authentication_service`: 1
- `cluster_autoscaler`: 3
- `dns`: 1
- `document_quality_improvement`: 1
- `elasticsearch`: 5
- `failover`: 4
- `fleet_insights`: 1
- `guest_proxy_service`: 3
- `healthelife_db_api`: 9
- `ingress`: 4
- `insights`: 2
- `k8s`: 13
- `kafka`: 17
...
- `lumberjack`: 1
- `max_ambient`: 31
- `max_clinical_automation`: 1
- `max_controlplane_ha_dr_canary`: 9
- `max_facade`: 14
- `max_frontend_services`: 3
- `max_genai_proxy`: 3
- `max_proposed_actions_backend`: 4
- `max_uec`: 6
- `mcms`: 11
- `metering`: 7
- `pe_canary`: 1
...
- `rqs`: 1
- `sds`: 3
- `semantic_query_service`: 2
- `sepsis_alert_service`: 1
- `serve`: 2
- `services`: 153
- `speech`: 1
- `storecentral`: 3
